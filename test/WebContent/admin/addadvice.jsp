						...
						<form action="advice/addAdvice.action" name="myform" method="post" onsubmit="return check()" class="form">
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>病历号</label> ${asign.ano } <input type="hidden" name="ano" id="ano" value="${asign.ano }" /> <input
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>内容</label> <input type="text" name="contents" class="form-control" id="contents" placeholder="请输入内容" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
