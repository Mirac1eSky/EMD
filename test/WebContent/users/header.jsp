				...
				<tr>
					...
					<td align="left">
							<table width="100" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td height="38" align="center">
										<a href="index/doctor.action" class="left"onmouseover="mopen('21')"
												onMouseOut="mclosetime()">医生信息</a>
									</td>
								</tr>
							</table>
										...
										<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left">
															<a href="index/hospital.action?id=${hos.hospitalid }"><font class="p14"><img src="images/biao.gif"
																	alt="图标" border="0">&nbsp;${hos.hospitalname }</font> </a>
														</td>
													</tr>
												</table>
											</td>
									...
									<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left">
															<a href="index/electronicMD.action"><font class="p14"><img src="images/biao.gif"
																	alt="图标" border="0">&nbsp;电子病历</font> </a>
														</td>
													</tr>
												</table>
											</td>
