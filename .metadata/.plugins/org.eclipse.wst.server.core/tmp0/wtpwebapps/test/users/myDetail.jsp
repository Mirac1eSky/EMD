						...
						<td align="left">
							<div class="z" id="z">
								<table width="99%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
									<tr>
										<td height="30" colspan="6" align="left" background="images/nzcms/list_bg.gif" class="white14B">我的医嘱</td>
									</tr>
									<tr>
									...
									<tr>
										<td height="30" colspan="6" align="left" bgcolor="#FFFFFF"></td>
									</tr>
									<tr>
										<td height="30" colspan="6" align="left" background="images/nzcms/list_bg.gif" class="white14B">处方</td>
									</tr>
									<tr align="center">
										<td align="center" bgcolor="#FFFFFF" colspan="2">医嘱号</td>
									...
									<c:forEach items="${sellList}" var="sell">
										<tr align="center" bgcolor="#FFFFFF">
											<td align="center" colspan="2">${sell.sno}</td>
