						...
						<form action="electronicmd/addElectronicMD.action" name="myform" method="post" onsubmit="return check()" class="form">
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>姓名</label> <input type="text" name="username" class="form-control" id="username" placeholder="请输入姓名" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>出院日期</label> <input type="text" name="hospitalization_date" class="form-control" id="birthday"
										onclick="WdatePicker()" readonly="readonly" placeholder="请输入出生日期" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>出院日期</label> <input type="text" name="discharge_date" class="form-control" id="birthday"
										onclick="WdatePicker()" readonly="readonly" placeholder="请输入出生日期" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>所在医院</label> <select name="hospitalid" class="form-control" id="hospitalid"><c:forEach
