...
<c:if test="${sessionScope.role eq '管理员' }">
	<div class="sidebar-nav">
		<ul>
			...
			<li><a data-target=".legal-menu4" class="nav-header collapsed" data-toggle="collapse">医生信息管理<i
					class="fa fa-collapse"></i></a></li>
			...
			<li><a data-target=".legal-menu2" class="nav-header collapsed" data-toggle="collapse">医院信息管理<i
					class="fa fa-collapse"></i></a></li>
			<li><ul class="legal-menu2 nav nav-list collapse">
					<li><a href="hospital/createHospital.action"><span class="fa fa-caret-right"></span>新增医院信息</a></li>
					<li><a href="hospital/getAllHospital.action"><span class="fa fa-caret-right"></span>医院信息列表</a></li>
					<li><a href="hospital/queryHospitalByCond.action"><span class="fa fa-caret-right"></span>医院信息查询</a></li>
				</ul></li>

			<li><a data-target=".legal-menu3" class="nav-header collapsed" data-toggle="collapse">科室信息管理<i
					class="fa fa-collapse"></i></a></li>
			...
			<li><a data-target=".legal-menu5" class="nav-header collapsed" data-toggle="collapse">患者用户信息管理<i
					class="fa fa-collapse"></i></a></li>
			<li><ul class="legal-menu5 nav nav-list collapse">
					<li><a href="users/getAllUsers.action"><span class="fa fa-caret-right"></span>患者用户信息列表</a></li>
					<li><a href="users/queryUsersByCond.action"><span class="fa fa-caret-right"></span>患者用户信息查询</a></li>
				</ul></li>

			<li><a data-target=".legal-menu6" class="nav-header collapsed" data-toggle="collapse">内容主题信息管理<i
					class="fa fa-collapse"></i></a></li>
			...
			<li><a data-target=".legal-menu7" class="nav-header collapsed" data-toggle="collapse">网站内容信息管理<i
					class="fa fa-collapse"></i></a></li>
			...
			<li><a data-target=".legal-menu8" class="nav-header collapsed" data-toggle="collapse">用户挂号信息管理<i
					class="fa fa-collapse"></i></a></li>
			...
			<li><a data-target=".legal-menu9" class="nav-header collapsed" data-toggle="collapse">评价信息管理<i
					class="fa fa-collapse"></i></a></li>
			<li><ul class="legal-menu9 nav nav-list collapse">
					<li><a href="topic/getAllTopic.action"><span class="fa fa-caret-right"></span>评价信息列表</a></li>
					<li><a href="topic/queryTopicByCond.action"><span class="fa fa-caret-right"></span>评价信息查询</a></li>
				</ul></li>

			<li><a data-target=".legal-menu10" class="nav-header collapsed" data-toggle="collapse">药品信息管理<i
					class="fa fa-collapse"></i></a></li>
			...
			<li><a data-target=".legal-menu11" class="nav-header collapsed" data-toggle="collapse">病例信息管理<i
					class="fa fa-collapse"></i></a></li>
			<li><ul class="legal-menu11 nav nav-list collapse">
					<li><a href="advice/getAllAdvice.action"><span class="fa fa-caret-right"></span>病例信息列表</a></li>
					<li><a href="advice/queryAdviceByCond.action"><span class="fa fa-caret-right"></span>病例信息查询</a></li>
				</ul></li>

			<li><a data-target=".legal-menu12" class="nav-header collapsed" data-toggle="collapse">处方信息管理<i
					class="fa fa-collapse"></i></a></li>
			<li><ul class="legal-menu12 nav nav-list collapse">
					<li><a href="sell/getAllSell.action"><span class="fa fa-caret-right"></span>处方信息列表</a></li>
					<li><a href="sell/querySellByCond.action"><span class="fa fa-caret-right"></span>处方信息查询</a></li>
				</ul></li>

			<li><a data-target=".legal-menu13" class="nav-header collapsed" data-toggle="collapse">留言交流信息管理<i
					class="fa fa-collapse"></i></a></li>
			<li><ul class="legal-menu13 nav nav-list collapse">
					<li><a href="bbs/getAllBbs.action"><span class="fa fa-caret-right"></span>留言交流信息列表</a></li>
					<li><a href="bbs/queryBbsByCond.action"><span class="fa fa-caret-right"></span>留言交流信息查询</a></li>
				</ul></li>

			<li><a data-target=".legal-menu14" class="nav-header collapsed" data-toggle="collapse">留言回复信息管理<i
					class="fa fa-collapse"></i></a></li>
			<li><ul class="legal-menu14 nav nav-list collapse">
					<li><a href="rebbs/getAllRebbs.action"><span class="fa fa-caret-right"></span>留言回复信息列表</a></li>
					<li><a href="rebbs/queryRebbsByCond.action"><span class="fa fa-caret-right"></span>留言回复信息查询</a></li>
				</ul></li>
	...
	<div class="sidebar-nav">
		<ul>
			<li><a data-target=".legal-menu7" class="nav-header collapsed" data-toggle="collapse">用户挂号信息管理<i
					class="fa fa-collapse"></i></a></li>
			<li><ul class="legal-menu7 nav nav-list collapse">
					<li><a href="asign/getTodayAsign.action"> <span class="title">今日用户挂号信息列表</span></a></li>
			...
			<li><a data-target=".legal-menu9" class="nav-header collapsed" data-toggle="collapse">电子病历管理<i
					class="fa fa-collapse"></i></a></li>
			<li><ul class="legal-menu9 nav nav-list collapse">
