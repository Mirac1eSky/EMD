						...
						<form action="advice/updateAdvice.action" name="myform" method="post" onsubmit="return check()" class="form">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>病历号</label> <input type="text" name="ano" class="form-control" id="ano" value="${advice.ano}" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
							...
							<div>
								<input type="hidden" name="adviceid" id="adviceid" value="${advice.adviceid}" /><input type="hidden"
									name="doctorid" id="doctorid" value="${advice.doctorid}" /> <input type="hidden" name="usersid" id="usersid"
									value="${advice.usersid}" /> <input type="hidden" name="addtime" id="addtime" value="${advice.addtime}" />
