 ...
 * Generated at: 2019-05-01 12:51:19 UTC
...
public final class querydzbl_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + path + "/";
      ...
      out.write("\t\t\t<h1 class=\"page-title\">电子病历信息列表</h1>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t<form action=\"dzbl/queryDzblByCond.action\" name=\"myform\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t<label>查询条件: <select name=\"cond\" style=\"width: 100px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"dzblid\">按病历号查询</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"usersid\">按患者姓名查询</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"hospitalization_date\">按住院日期查询</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"discharge_date\">按出院日期查询</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"doctersid\">按主治医生查询</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"ward\">按病房查询</option>\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /admin/querydzbl.jsp(42,4) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /admin/querydzbl.jsp(42,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("dzbl");
